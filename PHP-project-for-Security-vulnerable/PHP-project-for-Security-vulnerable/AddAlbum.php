...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $newAlbumId = isset($albumTitle, $albumDescription, $albumSelected) ? createAlbum($albumTitle, $albumDescription, $ownerId, $albumSelected) : false;
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select name="albumSelected" class="form-control">
                    ...
                    <option value="shared">Accessible only by owner and friends</option>
